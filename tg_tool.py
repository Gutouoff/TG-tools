...
DEFAULT_TEXTS = {
    ...
    't047': '{0} 无 .session 且 json 中无 session_str，该账号尚未导出登录态',
    't048': '登录态已失效(session 过期或在别处被踢)',
    't049': '账号不匹配：json 记录 user_id={0}，实际登录 {1}，已中止',
    't050': '账号: +{0}  昵称: {1} {2}',
    't050a': '正在连接账号: {0} …',
    't050b': '已切换到账号: {0}（保持在线）',
    't051': '  删除速度(每个动作的随机间隔):',
    ...
    't175': '[Bot] 启动失败: {0}',
    't176': '[Bot] 已停止',
    't177': '[Bot] 收到 {0} 个文件（用户 {1}），识别归档中…',
    't178': '[Bot] 导入成功: {0}',
    't179': '[Bot] 导入失败: {0}',
    't180': '[Bot] 已忽略非允许用户 {0} 的消息',
    't181': '[Bot] 文件 {0} 超过大小限制，已跳过',
    't183': '👋 我是账号收件箱 bot。\n你的 Telegram ID：{0}\n这台 bot 只接收允许列表内用户的文件——请把这个 ID 填进工具箱「设置 → Bot收件箱 → 允许的用户 ID」后再发。',
    't184': '📥 账号收件箱运行中（你的 ID：{0}）。\n把账号文件直接发给我：\n· .session（Telethon 会话）\n· 凭据 .json\n· zip（tdata 包 / session+json 包 / 加密账号包）\n· 2fa.txt\n多个文件可以一次全选转发；加密 zip 把密码写在转发的文字说明里。',
    't185': '⏳ 收到 {0} 个文件，识别归档中…',
    't186': '✅ {0}',
    't187': '❌ {0}',
    't188': '❌ 不支持的文件类型（{0}）。只接收 .session / .json / .zip / 2fa.txt',
    't189': '❌ 文件 {0} 超过大小限制（{1} MB），已跳过',
}
UI_TEXTS = {}
